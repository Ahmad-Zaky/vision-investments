...
<div class="page-content container-fluid">
                ...
                <table class="table no-wrap">
                  ...
                  <tbody>
                    <tr class="advanced-table active">
                      ...
                      <td>
                        <img src="/images/admin/1.jpg" class="rounded-circle" width="30">
                      </td>
                      <td>Andrew Simons</td>
                      <td>Modulator</td>
                      <td>6 May 2016</td>
                    ...
                    <tr class="advanced-table">
                      ...
                      <td>
                        <img src="/images/admin/2.jpg" class="rounded-circle" width="30">
                      </td>
                      <td>Hanna Gover</td>
                      <td>Admin </td>
                      <td>13 Jan 2005</td>
                    ...
                    <tr class="advanced-table">
                      ...
                      <td>
                        <img src="/images/admin/3.jpg" class="rounded-circle" width="30">
                      </td>
                      <td>Joshi Nirav</td>
                      <td>Admin</td>
                      <td>21 Mar 2001</td>
                    ...
                    <tr class="advanced-table">
                      ...
                      <td>
                        <img src="/images/admin/4.jpg" class="rounded-circle" width="30">
                      </td>
                      <td>Joshi Sunil</td>
                      <td>Admin</td>
                      <td>21 Mar 2004</td>
            ...
            <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
              <li class="list-group-item todo-item pt-0" data-role="task">
                ...
                <ul class="list-style-none assignedto mt-2">
                  <li class="assignee"><img class="assignee-img" src="/images/admin/1.jpg" alt="user"
                      data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                  <li class="assignee"><img class="assignee-img" src="/images/admin/2.jpg" alt="user"
                      data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                  <li class="assignee"><img class="assignee-img" src="/images/admin/3.jpg" alt="user"
                      data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                  <li class="assignee"><img class="assignee-img" src="/images/admin/4.jpg" alt="user"
                      data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                </ul>
              </li>
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label todo-label" for="customCheck1">
                    <span class="todo-desc">Give Purchase report to</span><span
                      class="badge badge-pill badge-danger font-medium text-white ml-1">Today </span>
                  </label>
                </div>
                <ul class="list-style-none assignedto mt-2">
                  <li class="assignee"><img class="assignee-img" src="/images/admin/1.jpg" alt="user"
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label todo-label" for="customCheck4">
                    <span class="todo-desc">Forward all tasks</span> <span
                      class="badge badge-pill badge-warning ml-1 text-white font-medium">2 weeks</span>
                  </label>
                </div>
                <div class="item-date"> 26 jun 2017</div>
              </li>
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label todo-label" for="customCheck6">
                    <span class="todo-desc">Important tasks</span><span
                      class="badge badge-pill badge-success font-medium text-white ml-1">2 weeks </span>
                  </label>
                </div>
                <ul class="list-style-none assignedto mt-2">
                  <li class="assignee"><img class="assignee-img" src="/images/admin/1.jpg" alt="user"
  ...
  <div class="row">
    <div class="col-md-6 col-lg-4">
      <div class="card">
        <img class="card-img-top" src="/images/admin/img1.jpg" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card">
        <img class="card-img-top" src="/images/admin/img2.jpg" alt="Card image cap">
        <div class="card-body">
          <div class="d-flex no-block align-items-center mb-3">
    ...
    <div class="col-md-6 col-lg-4">
      <div class="card">
        <img class="card-img-top" src="/images/admin/img3.jpg" alt="Card image cap">
        <div class="card-body">
          <div class="d-flex no-block align-items-center mb-3">
          ...
          <ul class="list-style-none chat-list">
            <li class="mb-3">
              <a href="javascript:void(0)">
                <div class="d-flex align-items-center">
                  <img src="/images/admin/1.jpg" class="rounded-circle" width="40">
                  <div class="ml-3">
            ...
            <li class="mb-3">
              <a href="javascript:void(0)">
                <div class="d-flex align-items-center">
                  <img src="/images/admin/2.jpg" class="rounded-circle" width="40">
                  <div class="ml-3">
            ...
            <li class="mb-3">
              <a href="javascript:void(0)">
                <div class="d-flex align-items-center">
                  <img src="/images/admin/3.jpg" class="rounded-circle" width="40">
                  <div class="ml-3">
            ...
            <li class="mb-3">
              <a href="javascript:void(0)">
                <div class="d-flex align-items-center">
                  <img src="/images/admin/4.jpg" class="rounded-circle" width="40">
                  <div class="ml-3">
            ...
            <li class="mb-3">
              <a href="javascript:void(0)">
                <div class="d-flex align-items-center">
                  <img src="/images/admin/5.jpg" class="rounded-circle" width="40">
                  <div class="ml-3">
            ...
            <li class="mb-3">
              <a href="javascript:void(0)">
                <div class="d-flex align-items-center">
                  <img src="/images/admin/6.jpg" class="rounded-circle" width="40">
                  <div class="ml-3">
                    <h5 class="mb-0 text-dark">Varun Dhavan</h5>
                    <small class="text-success">Online</small>
                  </div>
        ...
        <div class="card-body scrollable" style="height: 598px;">
          <div class="steamline mt-0">
            <div class="sl-item">
              ...
              <div class="sl-right">
                <div><a href="javascript:void(0)" class="link text-dark">John Doe</a> <span class="sl-date">5 minutes
                    ago</span>
            ...
            <div class="sl-item">
              ...
              <div class="sl-right">
                <div><a href="javascript:void(0)" class="link text-dark">Hritik Roshan</a> <span class="sl-date">5
                    minutes ago</span>
                  <p class="mt-1 font-light">Lorem Ipsum is simply dummy</p>
                </div>
                <div class="row mb-3">
                  <div class="col">
                    <img src="/images/admin/img1.jpg" class="img-fluid">
                  </div>
                  <div class="col">
                    <img src="/images/admin/img2.jpg" class="img-fluid">
                  </div>
                  <div class="col">
                    <img src="/images/admin/img3.jpg" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
            <div class="sl-item">
              <div class="sl-left"> <img src="/images/admin/1.jpg" alt="user" class="rounded-circle" /> </div>
              <div class="sl-right">
                <div><a href="javascript:void(0)" class="link text-dark">Gohn Doe</a> <span class="sl-date">5 minutes
                    ago</span>
            ...
            <div class="sl-item">
              <div class="sl-left"> <img src="/images/admin/2.jpg" alt="user" class="rounded-circle" /> </div>
              <div class="sl-right">
                <div><a href="javascript:void(0)" class="link text-dark">Varun Dhavan</a> <span class="sl-date">5
                    minutes ago</span>
            ...
            <div class="sl-item">
              <div class="sl-left"> <img src="/images/admin/5.jpg" alt="user" class="rounded-circle" /> </div>
              <div class="sl-right">
                <div><a href="javascript:void(0)" class="link text-dark">Tiger Sroff</a> <span class="sl-date">5 minutes
                    ago</span>
        ...
        <div class="card-body">
          <div class="chat-box scrollable" style="height:434px;">
            ...
            <ul class="chat-list">
              <!--chat Row -->
              <li class="chat-item">
                <div class="chat-img"><img src="/images/admin/1.jpg" alt="user"></div>
              ...
              <li class="odd chat-item">
                ...
                <div class="chat-img"><img src="/images/admin/2.jpg" alt="user"></div>
              </li>
              <!--chat Row -->
              <li class="chat-item">
                <div class="chat-img"><img src="/images/admin/3.jpg" alt="user"></div>
                <div class="chat-content">
                  <div class="box bg-light-success">
