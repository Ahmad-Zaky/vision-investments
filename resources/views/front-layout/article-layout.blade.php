...
<body
      ...
      <div class="vmag-opt-wrap">
        ...
        <div class="icon-wrapper">
          <ul class="social">
            ...
            <li>
              <a href="https://vision-tgi.com/Change">
                <div
        ...
        <div class="site-branding">
          ...
          <div class="site-title-wrapper">
            <div class="site-title-wrapper">
              <h1 class="site-title"><a href="https://vision-tgi.com/" rel="home">OFEED | Financial &amp; Economic
                  Feed</a></h1>
          ...
          <div class="vmagazine-nav-wrapper">
            <div class="vmagazine-container">
              ...
              <ul class="site-header-cart">
                <li class="cart-icon ">
                  <a href="https://vision-tgi.com/Login">
                    <span class="icon">
  ...
  var wc_add_to_cart_params = {
    "ajax_url": "https:\/\/www.ofeed.com",
    "wc_ajax_url": "https:\/\/www.ofeed.com",
    "i18n_view_cart": "View cart",
    "cart_url": "https:\/\/www.ofeed.com",
    "is_cart": "",
